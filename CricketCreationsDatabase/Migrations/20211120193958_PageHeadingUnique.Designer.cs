...
namespace CricketCreationsDatabase.Migrations
{
    ...
    [Migration("20211120193958_PageHeadingUnique")]
    partial class PageHeadingUnique
    {
            ...
            modelBuilder.Entity("CricketCreationsDatabase.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 11, 20, 11, 39, 57, 883, DateTimeKind.Local).AddTicks(9912),
                            Deleted = false,
                            Email = "michael@example.com",
                            LastUpdated = new DateTime(2021, 11, 20, 11, 39, 57, 885, DateTimeKind.Local).AddTicks(9270),
                            Name = "Michael",
                            Password = "9AS4j9rrsZ/jgdUTALNajZUyisNiBvZ3JOT6SHxrmdI=",
                            RefreshTokenExpiration = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Role = 0,
                            Salt = new byte[] { 26, 159, 230, 58, 142, 22, 220, 89, 141, 212, 186, 148, 29, 1, 58, 203 },
                            Surname = "Test",
                            UserName = "tacocat"
                        });
                });
