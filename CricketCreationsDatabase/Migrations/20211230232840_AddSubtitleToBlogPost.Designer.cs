...
namespace CricketCreationsDatabase.Migrations
{
    ...
    [Migration("20211230232840_AddSubtitleToBlogPost")]
    partial class AddSubtitleToBlogPost
    {
            ...
            modelBuilder.Entity("CricketCreationsDatabase.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 12, 30, 15, 28, 39, 517, DateTimeKind.Local).AddTicks(9753),
                            Deleted = false,
                            Email = "michael@example.com",
                            LastUpdated = new DateTime(2021, 12, 30, 15, 28, 39, 519, DateTimeKind.Local).AddTicks(9609),
                            Name = "Michael",
                            Password = "q4zNoVSkxQ4DBJ/RFdEXgDKRf4KfijJXCLD2iG/u2XU=",
                            RefreshTokenExpiration = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Role = 0,
                            Salt = new byte[] { 196, 108, 143, 162, 76, 208, 238, 6, 97, 237, 21, 170, 64, 241, 182, 103 },
                            Surname = "Test",
                            UserName = "tacocat"
                        });
                });
