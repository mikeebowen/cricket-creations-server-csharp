...
namespace CricketCreationsDatabase.Migrations
{
    ...
    [Migration("20210223010214_RemoveRefreshTokenExpiration")]
    partial class RemoveRefreshTokenExpiration
    {
            ...
            modelBuilder.Entity("CricketCreationsDatabase.Models.BlogPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(4738),
                            Deleted = false,
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(5233),
                            Published = false,
                        ...
                        new
                        {
                            Id = 2,
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Odio facilisis mauris sit amet massa vitae tortor condimentum lacinia. Lobortis scelerisque fermentum dui faucibus in. Faucibus ornare suspendisse sed nisi lacus sed viverra. Vulputate enim nulla aliquet porttitor lacus. Ridiculus mus mauris vitae ultricies leo integer malesuada nunc vel. Dignissim enim sit amet venenatis urna. Consequat id porta nibh venenatis cras sed felis eget velit. Amet cursus sit amet dictum sit amet justo. Sit amet risus nullam eget felis eget nunc lobortis mattis. Dui sapien eget mi proin sed libero. Ullamcorper malesuada proin libero nunc consequat interdum. Nunc consequat interdum varius sit amet mattis vulputate enim. Lacus vestibulum sed arcu non odio. Ullamcorper a lacus vestibulum sed arcu non. Duis at tellus at urna. Donec massa sapien faucibus et molestie ac feugiat sed lectus. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis aliquam.",
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6562),
                            Deleted = false,
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6572),
                            Published = false,
                        ...
                        new
                        {
                            Id = 3,
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Odio facilisis mauris sit amet massa vitae tortor condimentum lacinia. Lobortis scelerisque fermentum dui faucibus in. Faucibus ornare suspendisse sed nisi lacus sed viverra. Vulputate enim nulla aliquet porttitor lacus. Ridiculus mus mauris vitae ultricies leo integer malesuada nunc vel. Dignissim enim sit amet venenatis urna. Consequat id porta nibh venenatis cras sed felis eget velit. Amet cursus sit amet dictum sit amet justo. Sit amet risus nullam eget felis eget nunc lobortis mattis. Dui sapien eget mi proin sed libero. Ullamcorper malesuada proin libero nunc consequat interdum. Nunc consequat interdum varius sit amet mattis vulputate enim. Lacus vestibulum sed arcu non odio. Ullamcorper a lacus vestibulum sed arcu non. Duis at tellus at urna. Donec massa sapien faucibus et molestie ac feugiat sed lectus. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis aliquam.",
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6576),
                            Deleted = false,
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6578),
                            Published = false,
                        ...
                        new
                        {
                            Id = 4,
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Odio facilisis mauris sit amet massa vitae tortor condimentum lacinia. Lobortis scelerisque fermentum dui faucibus in. Faucibus ornare suspendisse sed nisi lacus sed viverra. Vulputate enim nulla aliquet porttitor lacus. Ridiculus mus mauris vitae ultricies leo integer malesuada nunc vel. Dignissim enim sit amet venenatis urna. Consequat id porta nibh venenatis cras sed felis eget velit. Amet cursus sit amet dictum sit amet justo. Sit amet risus nullam eget felis eget nunc lobortis mattis. Dui sapien eget mi proin sed libero. Ullamcorper malesuada proin libero nunc consequat interdum. Nunc consequat interdum varius sit amet mattis vulputate enim. Lacus vestibulum sed arcu non odio. Ullamcorper a lacus vestibulum sed arcu non. Duis at tellus at urna. Donec massa sapien faucibus et molestie ac feugiat sed lectus. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis aliquam.",
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6582),
                            Deleted = false,
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(6584),
                            Published = false,
            ...
            modelBuilder.Entity("CricketCreationsDatabase.Models.Page", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(9406),
                            Deleted = false,
                            Heading = "The About Page",
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 850, DateTimeKind.Local).AddTicks(9852),
                            Title = "About",
                            UserId = 1
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 851, DateTimeKind.Local).AddTicks(289),
                            Deleted = false,
                            Heading = "The Taco Page",
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 851, DateTimeKind.Local).AddTicks(297),
                            Title = "Taco",
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("CricketCreationsDatabase.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 2, 22, 17, 2, 13, 846, DateTimeKind.Local).AddTicks(3909),
                            Deleted = false,
                            Email = "michael@example.com",
                            LastUpdated = new DateTime(2021, 2, 22, 17, 2, 13, 848, DateTimeKind.Local).AddTicks(7049),
                            Name = "Michael",
                            Password = "+lhlbpWTx55+H5vqGc9KCbDIvNay99777jFD0dEm1Mg=",
                            Role = 0,
                            Salt = new byte[] { 189, 169, 193, 152, 43, 120, 57, 179, 155, 238, 223, 175, 169, 14, 216, 239 },
                            Surname = "Test",
                            UserName = "tacocat"
                        });
                });
